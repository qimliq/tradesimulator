...
class Algo7(TradeChecker):
    ...
    def run(self):
        ...
        self.setup_logger('algologger7', 'logs/algo7.txt', level=logging.DEBUG)
        algologger = logging.getLogger('algologger7')
        ...
        while startIndex <= last:
            ...
            for asset in assets:
                ...
                if asset.buynextday > 0 and low[index] < asset.buyprice:
                    ...
                    if self.capital >= buy_amount:
                        ...
                        algologger.info("Bought: %s bp:%0.2f q:%d sc:%d %s" % (
                        asset.name, asset.buyprice, asset.buycount, asset.stockcount, asset.series.Date.values[index]))
            ...
            for asset in assets:
                ...
                if self.capital >= min_amount and order_limit >= min_amount:
                    if close[index] > sma200[index] and close[index] > sma50[index]:
                        asset.buynextday = 1
        ...
        final = "Algo7[sma20/50/200]: Cap: %0.2f    MiS: %0.2f   P/L: %0.2f  Total: %0.2f \n" % (
